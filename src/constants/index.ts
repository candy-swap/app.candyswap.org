...
export const CANDY = new Token(ChainId.BSC_MAINNET, '0x288ca8240f7242637eddf3a013dac76a1d5899ab', 18, 'CANDY', 'CandySwap Token')
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.BSC_MAINNET]: [...WETH_ONLY[ChainId.BSC_MAINNET], B_DAI, BUSD, B_USDT, CANDY]
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.BSC_MAINNET]: [...WETH_ONLY[ChainId.BSC_MAINNET], B_USDT, BUSD, B_DAI, CANDY],
